...
wd = os.path.dirname("C:\\Users\\alber\\Desktop\\Active_Constraints\\Task_Data\\Thymectomy\\Thymectomy_3\\Thymectomy_post.py")
...
phr = u2r(pd.read_csv("C:\\Users\\alber\\Desktop\\Active_Constraints\\Task_Data\\Thymectomy\\SCENESTLS\\Phrenic_global.csv"))
...
SKIP = 4
axerr.scatter3D(phr['X'].iloc[::SKIP],phr['Y'].iloc[::SKIP],phr['Z'].iloc[::SKIP], color= "#0088ff",s=0.1)
