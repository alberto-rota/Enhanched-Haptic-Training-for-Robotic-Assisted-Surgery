...
kidneyplot = trisurf(kidney,'FaceColor','#632A23','EdgeAlpha',0,'FaceAlpha',0.5);
view(3)
...
quiver3(...
    ...
    vf.ConeApproachGuidanceVF_X0(1:round(1/density):end),...
    vf.ConeApproachGuidanceVF_Y0(1:round(1/density):end),...
    vf.ConeApproachGuidanceVF_Z0(1:round(1/density):end),...
