...
Other relevant simulators \cite{Bric2016} are the \textit{Mimic dV-Trainer} (dV-Trainer; Mimic Technologies, Inc, Seattle, WA, USA), the \textit{Robotic Surgical Simulator} (RoSS; Simulated Surgical Systems, Buffalo, NY, USA), and \textit{Sim-Surgery Educational Platform} (SEP, SimSurgery, Norway). Visual assistance algorithms are present in all the simulators above, but haptic guidance is missing.
