...
public class LogDataLiverResection : MonoBehaviour
{
    ...
    public string saveTo = @"C:\Users\User\Desktop\Alberto_Rota_MScThesis\Task_Data\LiverResection";
    string foldername;
    string folderpath;
    string path;
    ...
    public void Start() {
        ...
        File.Copy(saveTo+"\\LiverResectionPostOriginal.m", folderpath+"\\LiverResectionPost.m");
