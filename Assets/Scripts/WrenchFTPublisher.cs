...
{
    public class WrenchFTPublisher : UnityPublisher<MessageTypes.Geometry.Wrench>
    {
        ...
        private void UpdateMessage()
        {
            ...
            if (GameObject.FindWithTag("ROBOT").GetComponent<SumForces>() != null) {
                ...
                unitytorque = GameObject.FindWithTag("ROBOT").GetComponent<SumForces>().totalTorque*Global.assistance;
             }else {
