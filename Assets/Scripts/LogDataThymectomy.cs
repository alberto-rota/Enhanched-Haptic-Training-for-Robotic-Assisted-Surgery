...
public class LogDataThymectomy : MonoBehaviour
{
    ...
    public string saveTo = @"C:\Users\alber\Desktop\Active_Constraints\Assets\Logs\Thymectomy";
    string foldername;
    string folderpath;
    string path;
    ...
    void Start() {
        ...
        File.Copy("C:\\Users\\alber\\Desktop\\Active_Constraints\\Task_Data\\Thymectomy\\ThymectomyPostOriginal.m",
            folderpath+"\\ThymectomyPost.m");
