    ...
    public class WrenchFTPublisherLeft : UnityPublisher<MessageTypes.Geometry.Wrench>
    {
        ...
        private void UpdateMessage()
        {
            ...
            if (GameObject.FindWithTag("ROBOT").GetComponent<SumForcesRL>() != null) {
                unityforce = GameObject.FindWithTag("ROBOT").GetComponent<SumForcesRL>().totalForceLeft*Global.assistance;
                unitytorque = GameObject.FindWithTag("ROBOT").GetComponent<SumForcesRL>().totalTorqueLeft*Global.assistance;
             }else {
