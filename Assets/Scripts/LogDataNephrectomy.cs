...
public class LogDataNephrectomy : MonoBehaviour
{
    ...
    // public string saveTo = @"C:\Users\alber\Desktop\Active_Constraints\Task_Data\Nephrectomy";
    public string saveTo = @"C:\Users\User\Desktop\Alberto_Rota_MScThesis\Task_Data\Nephrectomy";
    string foldername;
    string folderpath;
    string path;
    ...
    public void Start() {
        ...
        File.Copy(saveTo+"\\NephrectomyPostOriginal.m", folderpath+"\\NephrectomyPost.m");
