...
\end{itemize}
For example, if $t=2$mm and $h=3$mm the surgeon will start to feel a force for errors higher than 2mm, and at 5mm he/she will half of the maximum force that can be delivered.
